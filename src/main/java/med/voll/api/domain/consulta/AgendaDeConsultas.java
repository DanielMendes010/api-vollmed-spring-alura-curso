...
public class AgendaDeConsultas {
    ...
    @Autowired
    private List<ValidadorAgendamentoConsulta> validacoesAgendamentoConsulta;

    @Autowired
    private List<ValidadorCancelamentoDeConsulta> validacoesCancelamentoDeConsultas;
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados) {
        ...
        validacoesAgendamentoConsulta.forEach(v -> v.validar(dados));

        var medico = escoherMedico(dados);
        if (medico == null) {
    ...
    public void cancelar(DadosCancelamentoConsulta dados) {
        ...
        validacoesCancelamentoDeConsultas.forEach(v -> v.validar(dados));

        var consulta = consultaRepository.getReferenceById(dados.idConsulta());
        consulta.cancelar(dados.motivo());
    }

    public Medico escoherMedico(DadosAgendamentoConsulta dados) {
